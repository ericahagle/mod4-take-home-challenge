    ...
    <>
      {source !== '[Removed]' &&
        <div className='ArticlePreview'>
          {imageUrl ? (<img className='preview-image' src={imageUrl} alt={title} />) : (<img className='preview-image' src={`${process.env.PUBLIC_URL}/no-image-available.jpg`} alt='No Image Available' />)}
